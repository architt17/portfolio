      ...
      <div className='container contact_container'>
        <div className='contact_options'>
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h6>architswami17@gmail.com</h6>
            <a href='mailto:architswami17@gmail.com'>Send A Mail</a>
          </article>
          <article className='contact_option'>
            <BsWhatsapp className='contact_option_icon'/>
            <h4>Whatsapp</h4>
            <h6>+91-6387233320</h6>
            <a href='https://api.whatsapp.com/send?phone=916387233320'>Send Whatsapp Message</a>
          </article>
        </div>
