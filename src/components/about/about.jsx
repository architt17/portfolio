    ...
    <section id="about">
      ...
      <div className="container about_container">
        ...
        <div className="about_content">
          ...
          <p>Hey! This is Archit Swami and I'm currently pursuing my B.Tech in computer science from Lovely Professional University (LPU). I'm a detail-oriented person and can juggle between tasks. I love to read about new techs and technological books in my spare time. 
